...
export function ContactosLayout() {
  return (
    <section  id="contactos" className=" scroll-mt-25 md:scroll-mt-24 p-10 w-full mt-10 font-sans flex flex-col items-center gap-10">
      <h2
      ...
      >
        ...
        >
          ...
          <address className="not-italic">
            ...
            <p>Jr. Diego Cisneros Nº 382 - Urb Sta. Luzmila - Comas, Lima, Perú</p>
            <p>
              Teléfono:{" "}
              <a
